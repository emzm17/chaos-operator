...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MemoryStressSpec) DeepCopyInto(out *MemoryStressSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MemoryStressSpec.
func (in *MemoryStressSpec) DeepCopy() *MemoryStressSpec {
	if in == nil {
		return nil
	}
	out := new(MemoryStressSpec)
